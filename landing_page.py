...
class LandingPage:
    ...
    alien_one_imgs = [pg.transform.rotozoom(pg.image.load(f'images/alien_0{n}.png'), 0, 1) for n in range(2)]
    alien_two_imgs = [pg.transform.rotozoom(pg.image.load(f'images/alien_1{n}.png'), 0, 1) for n in range(2)]
    alien_three_imgs = [pg.transform.rotozoom(pg.image.load(f'images/alien_2{n}.png'), 0, 1) for n in range(2)]
    ufo_imgs = [pg.transform.rotozoom(pg.image.load(f'images/alien2_{n}.png'), 0, 0.7) for n in range(2)]
