...
# file_wav = file_wav.close()
# file_wav.setframerate(frequency*5)
...
class Sound:
    ...
    def play_ufo(self):
        pg.mixer.Sound.set_volume(self.ufo, 0.5)
        self.play_sound(self.ufo)

    def stop_ufo(self): pg.mixer.Sound.set_volume(self.ufo,0.0)
